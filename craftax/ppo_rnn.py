...
def parse_args():
    ...
    parser.add_argument("--policy_path", type=str, default="./policies/300000000/default", help="Name of the run")
    ...
    parser.add_argument("--aux_coef", type=float, default=0.025, help="Auxiliary coefficient")
...
def make_train(config):
    ...
    def train(rng):
        ...
        if config["USE_POLICY"]:
            ...
            restored_train_state = checkpointer.restore(config["POLICY_PATH"])
